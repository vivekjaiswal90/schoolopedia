    ...
    <div class="col-sm-12">
        <div class="panel panel-white">
            ...
            <div class="panel-body">
                <form action="{{ URL::route('user-class-set-initial-post'); }}" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-offset-4 col-md-4">
                            <div class="form-group no-display">
                                ...
                                <select id="form-field-select-stream" class="form-control" name="stream_id">
                                    ...
                                    @foreach($streams as $stream => $value)
                                    <option value="{{ $streams[$stream]->id }}">{{ $streams[$stream]->stream_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
<script src="{{ URL::asset('assets/js/modifiedJs/user/initial-settings.js'); }}"></script>
<script>

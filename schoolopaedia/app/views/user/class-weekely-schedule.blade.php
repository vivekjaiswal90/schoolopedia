                ...
                <ul class="tab-left">
                    <table class="timetable">
                        ...
                        <tbody>
                            <tr>
                                <td> 05.00 - 06.00 </td>
                                <td class="event no-margin">
                                    <div class="names pull-left"> 
                                        <div class="subject-name tooltips" data-placement="top" data-rel="tooltip" data-original-title="Subject Name">
                                            Science
                                        </div>
                                        <div class="teacher-name tooltips" data-placement="left" data-rel="tooltip" data-original-title="Teacher Name">
                                            Sumit Singh
                                        </div>
                                    </div>
                                    <div class="teacher-image pull-right tooltips" data-placement="right" data-rel="tooltip" data-original-title="Teacher Picture">
                                        <a href="#" title="Boxing">
                                            <img class="thumbnail" src="{{ URL::asset('assets/images/avatar-1-big.jpg'); }}" height="40px" width="40px" alt="Sumit Singh">
                                        </a>
                                    </div>
                                </td>
                                <td class="event no-margin">
                                    ...
                                    <div class="teacher-image pull-right tooltips" data-placement="right" data-rel="tooltip" data-original-title="Teacher Picture">
                                        <a href="#" title="Boxing">
                                            <img class="thumbnail" src="{{ URL::asset('assets/images/avatar-2.jpg'); }}" height="40px" width="40px" alt="Arvind Kushwaha">
                                        </a>
                                    </div>
                                </td>
                                <td></td>
                                <td class="event no-margin">
                                    ...
                                    <div class="teacher-image pull-right tooltips" data-placement="down" data-rel="tooltip" data-original-title="Teacher Picture">
                                        <a href="#" title="Boxing">
                                            <img class="thumbnail" src="{{ URL::asset('assets/images/avatar-3.jpg'); }}" height="40px" width="40px" alt="Sushil Singh Shinde">
                                        </a>
                                    </div>
                                </td>
                                <td></td>
                                ...
                                <td class="event no-margin">
                                    ...
                                    <div class="teacher-image pull-right tooltips" data-placement="down" data-rel="tooltip" data-original-title="Teacher Picture">
                                        <a href="#" title="Boxing">
                                            <img class="thumbnail" src="{{ URL::asset('assets/images/avatar-3.jpg'); }}" height="40px" width="40px" alt="Sushil Kumar">
                                        </a>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="event"><a href="#" title="Boxing">Boxing</a>12.00 -
                                    15.45
                                </td>
                                    ...
                                    <div class="panel-body">
                                        <ul class="items_list"><h3>Monday</h3>
                                            <li>
                                                ...
                                                <span class="m_31">10.00 - 20.00</span>
                                                <div class="clear"></div>
                                            </li>

            ...
            <div class="panel-body messages">
                <ul class="messages-list col-md-4">
                    ...
                    <li class="messages-item">
                        ...
                        <img alt="" src="{{ URL::asset('assets/images/avatar-1.jpg'); }}" class="messages-item-avatar">
                    ...
                    <li class="messages-item active starred">
                        ...
                        <img alt="" src="{{ URL::asset('assets/images/avatar-2.jpg'); }}" class="messages-item-avatar">
                    ...
                    <li class="messages-item">
                        ...
                        <img alt="" src="{{ URL::asset('assets/images/avatar-3.jpg'); }}" class="messages-item-avatar">

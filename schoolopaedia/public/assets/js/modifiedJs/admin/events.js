    ...
    var runFullCalendarValidation = function(el) {
        ...
        formEvent.validate({
            ...
            errorPlacement: function(error, element) { // render error placement for each input type
                ...
                } else if (element.hasClass("event-categories")) {
                    console.log(element);
            ...
            messages: {
                ...
                eventCategory: "* Please Choose a Event Category"
            ...
            submitHandler: function(form) {
                ...
                newEvent.category = $(".form-full-event .event-categories option:checked").val();
